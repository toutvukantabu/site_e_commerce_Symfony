 ...
 */
final class Version20210915210105 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE purshase_item DROP FOREIGN KEY FK_48066C954584665A');
        $this->addSql('ALTER TABLE purshase_item DROP FOREIGN KEY FK_48066C95558FBEB9');
